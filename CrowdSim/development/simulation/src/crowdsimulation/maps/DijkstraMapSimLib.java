                            ...
                            if (theObjs != null) {
                                if (theObjs.isEmpty()) {
                                   // System.out.println("No Obstacles");
                                    ...
                                    //check to see if the obstacle is Station.
                                    //System.out.println("The Objs size " + theObjs.size());
                                    for (int k = 0; k < theObjs.size(); k++) {
                                        Object aObj = (Object) theObjs.get(k);
                                        ...
                                        for (int j = 0; j < obstacles.length; j++) {
                                            ...
                                            Vector2D loc = new Vector2D(center.x * 0.4, center.y * 0.4);
                                            if (aObstacle.isInside(loc)) {
                                                if (aObstacle instanceof StationObstacle) {
                                                    //System.out.println("Is Instance of Station");
                                                    Vector2D exitVec = new Vector2D(source.x, source.y);
                                                    if (exitVec.distance(x, y) < 6) {
                                                        theConnInd.add(i);
                                                    }
                                                } else {
                                                   // System.out.println("Not Instance of Station");
                                                }
